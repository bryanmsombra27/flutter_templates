...
class AnimatedTransactionCard extends StatefulWidget {
  const AnimatedTransactionCard({super.key});

  static const name = "transaction_card";

  @override
  State<AnimatedTransactionCard> createState() => _TransactionCardState();
}

class _TransactionCardState extends State<AnimatedTransactionCard> {
